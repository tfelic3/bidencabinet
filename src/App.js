...
<Router> 
   ...
   <Container className="grid">
    ...
    <Route exact path="/" render={() => <Cabinet candidates={this.state.candidates}/>} />

    <Route exact path="/cabinet/:title" render={({match}) => 
    <CabinetView cabinet={this.state.candidates.find(m => m.title === match.params.title)}/>}/>
